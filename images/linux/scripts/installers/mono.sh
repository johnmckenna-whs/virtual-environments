...
echo "deb https://download.mono-project.com/repo/ubuntu stable-$LSB_CODENAME/snapshots/5.12.0.301 main" | tee /etc/apt/sources.list.d/mono-official-stable.list
apt-get update
